...
class URLFromMessageParserTest {
    ...
    fun getUrlsForParensBracketsStrip(): Array<Array<Any>> {
        return arrayOf(
                arrayOf("ftp://non.http.url.com", NONE),
                arrayOf("someone says http but it's not a url", NONE),
                arrayOf("someone says https but it's not a url", NONE),
                arrayOf("http://sample.com", expectedUrls("http://sample.com")),
